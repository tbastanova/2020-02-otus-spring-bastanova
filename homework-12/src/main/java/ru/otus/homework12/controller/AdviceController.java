...
import ru.otus.homework12.exception.NoCategoryFoundException;
import ru.otus.homework12.exception.NoCommentFoundException;
...
public class AdviceController {
    ...
    public ModelAndView handleException(Exception e) {
        ModelAndView modelAndView = new ModelAndView("error");
        modelAndView.addObject("message", "Что-то пошло не так");
        return modelAndView;
    }
}
